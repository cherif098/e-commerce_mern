...
const Add = ({ token }) => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className="flex flex-col w-full  gap-3 ">
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-full  sm:gap-7">
        <div>
        ...
        <div>
          <p className="m-2">Product Subcategory</p>
          <select
        ...
        <div>
          ...
          <input
            ...
            value={price}
            className="w-full py-1 px-3 sm:w-[120px]"
            type="number"
            placeholder="00.00"
          />
        </div>
      ...
      <div>
        ...
        <div className="flex gap-2">
          ...
          >
            <p
              className={`${
                sizes.includes("S") ? "bg-[#b97633]" : "bg-[#f1efe7] "
          ...
          >
            <p
              className={`${
                sizes.includes("M") ? "bg-[#b97633]" : "bg-[#f1efe7] "
              } px-3 py-1  cursor-pointer`}
            >
              M
            </p>
          ...
          >
            <p
              className={`${
                sizes.includes("L") ? "bg-[#b97633]" : "bg-[#f1efe7] "
              } px-3 py-1  cursor-pointer`}
            >
              L
            </p>
          ...
          >
            <p
              className={`${
                sizes.includes("XL") ? "bg-[#b97633]" : "bg-[#f1efe7] "
              } px-3 py-1  cursor-pointer`}
            >
              XL
            </p>
          ...
          >
            <p
              className={`${
                sizes.includes("XXL") ? "bg-[#b97633]" : "bg-[#f1efe7] "
              } px-3 py-1  cursor-pointer`}
            >
              XXL
            </p>
